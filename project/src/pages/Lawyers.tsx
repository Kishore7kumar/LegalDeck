...
import { Search, MapPin, DollarSign, Clock, Star, Filter, Calendar, ArrowRight } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {showBooking && selectedLawyer && (
            <div className="bg-white rounded-xl shadow-lg p-6">
              <div className="mb-6">
                <h3 className="text-xl font-semibold mb-2">Book Consultation with {selectedLawyer.name}</h3>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['9:00 AM', '10:00 AM', '2:00 PM', '3:00 PM'].map((time) => (
                      <button
                        key={time}
                        className="flex items-center justify-center px-4 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors"
                      >
